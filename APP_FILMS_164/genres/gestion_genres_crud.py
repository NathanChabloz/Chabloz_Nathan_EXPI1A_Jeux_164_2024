        ...
        try:
            with DBconnection() as mc_afficher:
                if order_by == "ASC" and id_genre_sel == 0:
                    ...
                    mc_afficher.execute(strsql_categore_afficher)
                elif order_by == "ASC":
                    ...
                    valeur_id_categorie_selected_dictionnaire = {"value_id_categorie_selected": id_genre_sel}
                    strsql_categore_afficher = """SELECT * FROM t_catégorie ORDER BY id_categorie WHERE id_categorie = %(value_id_categorie_selected)s"""

                    mc_afficher.execute(strsql_categore_afficher, valeur_id_categorie_selected_dictionnaire)
                else:
                ...
                print("data_categorie ", data_genres, " Type : ", type(data_genres))
...
def genre_update_wtf():
    ...
    try:
        ...
        if request.method == "POST" and form_update.submit.data:
            ...
            str_sql_id_genre = "SELECT id_categorie, nom_categorie FROM t_catégorie " \
    ...
    try:
        ...
        if request.method == "POST" and form_delete.validate_on_submit():
            ...
            if form_delete.submit_btn_del.data:
                ...
                str_sql_delete_films_genre = """DELETE FROM t_catégorie_jeux WHERE fk_catégorie = %(value_id_genre)s"""
                str_sql_delete_idgenre = """DELETE FROM t_catégorie WHERE id_categorie = %(value_id_genre)s"""
        ...
        if request.method == "GET":
            ...
            str_sql_genres_films_delete = """SELECT id_catégorie_jeux, nom_jeu, id_categorie, nom_categorie FROM t_catégorie_jeux 
                                            ...
                                            WHERE fk_catégorie = %(value_id_genre)s"""
